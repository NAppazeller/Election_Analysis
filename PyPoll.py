...
#3. Number of of votes each candidiate recieved
#4. % of votes each candidate received
#5. Identify winner by popular vote
...
# Write results to our text file.
with open(file_to_save, "w") as txt_file:        
    ...
    # Write winning candidate's name to the text file.
